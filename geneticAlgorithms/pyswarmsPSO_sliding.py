...
class PySwarmsPSO_sliding:
    def __init__(self, rectangles, config: dict, store_best_solution_per_gen : bool = True):
    ...
    def myFitnessFunc(self, swarm_positions):
        """
        swarm_positions shape: (n_particles, n_rectangles * 2)
